...
export default function PatientSelfMonitoringPage() {
  const { currentUser, patients, nurses, caregivers, familyMembers, alerts } =
    useApp();

  // Find patient by currentUser name (same logic as PatientDashboard)
  const patient =
  ...
  return (
    <AppShell>
      <div className="p-4 md:p-6">
        ...
        {/* Read-only notice */}
        <div className="mb-4 flex items-center gap-2 text-xs text-muted-foreground bg-muted/40 rounded-lg px-3 py-2">
          <Eye size={12} />
          View-only access — your care team manages medical settings
        </div>
        ...
        <Tabs defaultValue="live">
          <TabsList className="w-full overflow-x-auto flex justify-start h-auto p-1 gap-0.5 mb-5">
            <TabsTrigger
              ...
              data-ocid="patient.monitoring.live_tab"
            >
            ...
            <TabsTrigger
              value="posture"
              className="text-xs px-2.5 py-1.5"
              data-ocid="patient.monitoring.posture_tab"
            >
            ...
            <TabsTrigger
              value="gesture"
              className="text-xs px-2.5 py-1.5"
              data-ocid="patient.monitoring.gesture_tab"
            >
            ...
            <TabsTrigger
              value="unknown"
              className="text-xs px-2.5 py-1.5"
              data-ocid="patient.monitoring.unknown_tab"
            >
            ...
            <TabsTrigger
              value="saline"
              className="text-xs px-2.5 py-1.5"
              data-ocid="patient.monitoring.saline_tab"
            >
            ...
            <TabsTrigger
              value="history"
              className="text-xs px-2.5 py-1.5"
              data-ocid="patient.monitoring.history_tab"
            >
            ...
            {patient.postureStatus === "Fallen" && (
              <div className="bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-xl p-4 alert-pulse">
                ...
                <p className="text-sm text-red-600 dark:text-red-400">
                  Alert has been sent to your nursing staff. Immediate
            ...
            <Card className="shadow-medical border-0">
              <CardContent className="p-6">
                <div className="text-center mb-4">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    AI monitoring your hand movements for emergency signals
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            {patient.salineLevel < 5 && (
              <div className="bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-xl p-4 alert-pulse">
                ...
                <p className="text-sm text-red-600 dark:text-red-400 mt-1">
                  Immediate refill required. Staff has been alerted.
                </p>
              </div>
            )}
            {patient.salineLevel >= 5 && patient.salineLevel < 20 && (
              <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-4">
                ...
                <p className="text-sm text-yellow-600 dark:text-yellow-500 mt-1">
                  Saline level below 20%. Staff has been notified.
                </p>
              </div>
            )}
