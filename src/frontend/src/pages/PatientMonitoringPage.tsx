...
export default function PatientMonitoringPage() {
  const { id } = useParams({ from: "/nurse/patient/$id" });
  const {
    patients,
    nurses,
    caregivers,
        ...
        <Tabs defaultValue="live">
          <TabsList className="w-full overflow-x-auto flex justify-start h-auto p-1 gap-0.5 mb-5">
            ...
            <TabsTrigger
              value="posture"
              className="text-xs px-2.5 py-1.5"
              data-ocid="monitoring.posture_tab"
            >
            ...
            <TabsTrigger
              value="gesture"
              className="text-xs px-2.5 py-1.5"
              data-ocid="monitoring.gesture_tab"
            >
            ...
            <TabsTrigger
              value="unknown"
              className="text-xs px-2.5 py-1.5"
              data-ocid="monitoring.unknown_tab"
            >
            ...
            <TabsTrigger
              value="saline"
              className="text-xs px-2.5 py-1.5"
              data-ocid="monitoring.saline_tab"
            >
            ...
            <TabsTrigger
              value="history"
              className="text-xs px-2.5 py-1.5"
              data-ocid="monitoring.history_tab"
            >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    {POSTURE_OPTIONS.map((posture) => (
                      <Button
                        ...
                        data-ocid="monitoring.posture_simulate_button"
                      >
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <Slider
                    ...
                    className="w-full"
                    data-ocid="monitoring.saline_slider"
                  />
