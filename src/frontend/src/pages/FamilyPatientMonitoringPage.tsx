...
export default function FamilyPatientMonitoringPage() {
  const { id } = useParams({ from: "/family/patient/$id" });
  const { patients, nurses, caregivers, familyMembers, alerts } = useApp();
    ...
    <AppShell>
      <div className="p-4 md:p-6">
        ...
        <div className="mb-4 flex items-center gap-2 text-xs text-muted-foreground bg-muted/40 rounded-lg px-3 py-2">
          <Eye size={12} />
          View-only access — changes require medical staff authorization
        </div>
        ...
        <Tabs defaultValue="live">
          <TabsList className="w-full overflow-x-auto flex justify-start h-auto p-1 gap-0.5 mb-5">
            <TabsTrigger
              ...
              data-ocid="family.monitoring.live_tab"
            >
            ...
            <TabsTrigger
              value="posture"
              className="text-xs px-2.5 py-1.5"
              data-ocid="family.monitoring.posture_tab"
            >
            ...
            <TabsTrigger
              value="gesture"
              className="text-xs px-2.5 py-1.5"
              data-ocid="family.monitoring.gesture_tab"
            >
            ...
            <TabsTrigger
              value="unknown"
              className="text-xs px-2.5 py-1.5"
              data-ocid="family.monitoring.unknown_tab"
            >
            ...
            <TabsTrigger
              value="saline"
              className="text-xs px-2.5 py-1.5"
              data-ocid="family.monitoring.saline_tab"
            >
            ...
            <TabsTrigger
              value="history"
              className="text-xs px-2.5 py-1.5"
              data-ocid="family.monitoring.history_tab"
            >
